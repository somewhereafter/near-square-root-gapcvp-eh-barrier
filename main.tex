...
$\mathsf{NP}=\mathsf{coNP}$.  This constant sharpening is proved here; it is
not attributed to the literal published statement of Aharonov--Regev.
\end{abstract}
...
confirms the endpoint consequence stated in Mira's draft~\cite{Mira26}, while
making the published-versus-new proof boundary explicit.
...
\begin{enumerate}
  ...
  \item We prove the constant-sensitive Aharonov--Regev sharpening and its
  $\mathsf{NP}=\mathsf{coNP}$ consequence at the exact unit square-root
  factor.
\end{enumerate}
...
any leading-constant ambiguity.
...
\]
This uses the verified constant-sensitive sharpening in
Theorem~\ref{thm:arsharp}; the published Aharonov--Regev theorem itself states
only the existence of an absolute constant and displays the safe value $100$.
